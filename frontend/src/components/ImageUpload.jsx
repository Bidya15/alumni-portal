            ...
            return (
                <div className={styles.filePreviewWrapper}>
                    ...
                    <div className={styles.fileInfo}>
                        <div className={styles.fileName}>{preview.replace('PDF: ', '')}</div>
        ...
        <div className={styles.imageUploadContainer}>
            ...
            <div className={styles.imageUploadControls}>
                {selectedFormat !== "url" && (
                    <div className={styles.uploadBtnGroup}>
                        ...
                        >
                            {isUploading ? '⏳ Uploading...' : `📁 Choose ${selectedFormat === 'pdf' ? 'PDF' : selectedFormat === 'url' ? 'URL' : 'Image'}`}
                        </button>
                    </div>
                )}
                ...
                <div className={styles.urlInputGroup}>
                    {selectedFormat === "url" ? (
                        ...
                        <input
                            ...
                            value={preview.startsWith('data:') || preview.startsWith('PDF:') ? '' : preview}
                            onChange={(e) => handleUrlChange(e.target.value)}
                        />
                    )}
                </div>
            ...
            <div className={styles.imageUploadInfo}>
                <small className="text-gray">
                    {selectedFormat === "image" && `Max size: ${maxSizeMB}MB • Formats: JPG, JPEG, PNG, GIF, WebP`}
                    {selectedFormat === "pdf" && `Max size: ${maxSizeMB}MB • Format: PDF only`}
